...
?>
  ...
  ?>
    ...
    <div class="col-12 border border-3 rounded-5 p-3 mb-2 d-flex justify-content-between">
      <div class="d-flex align-items-center col-5">
        <img src="<?php echo $d["path"] ?>" class="rounded-4" width="180px" height="180px" />
        <div class="ms-5">
      ...
      <div class="d-flex align-items-center">
        <h5>Total: <span class="text-warning"><?php echo $total ?></span></h5>
      </div>
      <div class="d-flex align-items-center">
  ...
  <div class="d-flex flex-column align-items-end">
    ...
    <h5>Delivery Fee: <span class="text-muted">Rs. 500</span></h5>
    <h3>Net Total: <span class="text-warning"><?php echo ($netTotal + 500) ?></span></h5>
